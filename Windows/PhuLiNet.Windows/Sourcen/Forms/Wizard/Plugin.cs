...
namespace Windows.Core.Forms.Wizard
{
    ...
    public class Plugin
    {
        ...
        /// <summary>
        /// Returns the controls that the plugin specifies as belonging in the wizard container.
        /// </summary>
        public List<Control> GetControls()
        {
            return _instance.GetControls();
        }
        ...
        {
            get { return _instance.IsLoaded; }
            set { _instance.IsLoaded = value; }
        }

        public void PluginLoaded()
        {
            _instance.PluginLoaded();
        }
    }
}