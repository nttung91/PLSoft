...
{
    /// <summary>
    /// Rule ensuring that a Integer has a maximum value of x.
    /// </summary>
    public class IntegerMaxValue : CommonBusinessRule
    {
        ...
        public IntegerMaxValue(IPropertyInfo primaryProperty, int compareValue)
        ...
        protected override void Execute(RuleContext context)
        {
            ...
            if (value != null)
            {
                ...
                {
                    string message = string.Format(ResourcesValidation.IntegerMaxValue, CompareValue.ToString());
