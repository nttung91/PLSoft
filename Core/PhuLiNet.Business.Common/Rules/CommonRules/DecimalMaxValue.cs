...
{
    /// <summary>
    /// Rule ensuring that a decimal has a maximum value of x.
    /// </summary>
    public class DecimalMaxValue : CommonBusinessRule
    {
        ...
        public DecimalMaxValue(IPropertyInfo primaryProperty, decimal compareValue)
        ...
        protected override void Execute(RuleContext context)
        {
            ...
            if (value != null)
            {
                ...
                {
                    string message = string.Format(ResourcesValidation.DecimalMaxValue, CompareValue.ToString());
