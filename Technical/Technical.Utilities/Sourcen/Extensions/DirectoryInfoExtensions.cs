...
namespace Technical.Utilities.Extensions
{
    ...
    public static class DirectoryInfoExtensions
    {
        ...
        private static void FindFilesRecursive(DirectoryInfo directory, Func<FileInfo, bool> predicate,
        ...
        public static DirectoryInfo GetLatestModified(this DirectoryInfo[] directoryInfoList)
        {
            var result =
                (from sortedDirs in directoryInfoList
                    orderby sortedDirs.LastWriteTime descending
                    select sortedDirs).FirstOrDefault();
