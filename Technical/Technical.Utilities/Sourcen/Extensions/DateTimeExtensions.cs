...
using Technical.Utilities.Extensions.SystemDependencies;
...
namespace Technical.Utilities.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Indicates whether the date is past
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        public static bool IsDatePast(this DateTime dt)
        {
            return (dt.Date < DateTime.Today);
        }

        /// <summary>
        /// Indicates whether the date is past or is today
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        public static bool IsDatePastOrToday(this DateTime dt)
        {
            return (dt.Date <= DateTime.Today);
        }
