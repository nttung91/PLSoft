...
namespace Technical.Utilities.Extensions
{
    ...
    public static class ObjectExtensions
    {
        ...
        {
            T result = default(T);
            ObjectConverter.TryConvert(value, out result);

            return result;
        }

        public static object ConvertOrDefault(this object value, Type toType)
        {
            object result = null;
            ObjectConverter.TryConvert(value, toType, out result);
        ...
        {
            return ObjectConverter.TryConvert(value, out result);
        }
        ...
        /// <returns></returns>
        public static bool IsNullable<T>(this T target)
        {
            if (target == null) return true; // obvious
            Type type = typeof (T);
        ...
        /// <summary>
        /// Is this a nullable value type
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="target"></param>
        /// <returns></returns>
        public static bool IsNullableValueType<T>(this T target)
        {
            Type type = typeof (T);
            if (Nullable.GetUnderlyingType(type) != null) return true; // Nullable<T>
            return false; // value-type
        ...
        {
            return ToStringDumpInternal(o.ToXElement(flags, maxArrayElements))
        ...
        public static string ToHTMLTable(this object o,
            ...
            int maxArrayElements = 5)
        {
            return ToHTMLTableInternal(o.ToXElement(flags, maxArrayElements), 0)
                .Aggregate(String.Empty, (str, el) => str + el);
        }
        ...
        {
            return String.Format("{0}{1}{2}", String.Empty.PadRight(padding, '\t'), tag, System.Environment.NewLine);
        }
